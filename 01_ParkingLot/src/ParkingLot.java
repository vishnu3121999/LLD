 ...
 * 12. The system should support a per-hour parking fee model.
...
public class ParkingLot {
    ...
    public static void main(String[] args) {
        ...
        // initialize parkingLot & Entry,Exits
        var lot = new ParkingLot();

        var floor0 = new Floor();
        var floor1 = new Floor();

        floor0.spots.add(new Spot(01,SpotType.COMPACT,false));
        floor1.spots.add(new Spot(11,SpotType.LARGE,false));

        lot.floors.add(floor1);
        lot.floors.add(floor0);
